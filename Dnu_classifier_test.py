...
# Classifier path
pclass = '/Users/z5288589/CLASSIFIER/' # make sure contains: "Metrics_scaling", "Data_models_NB_Oct14", "ensemble_v16"

# Power Spectra folder:
dpath = '/Users/z5288589/CLASSIFIER/psd/'

# global parameters folder:
dp = '/Users/z5288589/CLASSIFIER/global_2.dat'

# Where to save results? Use final "/"
saveto = '/Users/z5288589/CLASSIFIER/results_sree/'
...
if __name__ == '__main__':
    ...
    if (((sys.argv[1]) == 'save') and (os.path.isfile(pclass+'previous.pkl'))):
        use_saved_pickle = True
    else:
        use_saved_pickle = False
    ...
    if not use_saved_pickle:
        ...
        tmp1.to_pickle(pclass+'previous.pkl')
    ...
    if use_saved_pickle:
        tsamp = pd.read_pickle(pclass+'previous.pkl')
    else:
        tsamp = tmp1.copy()
